...
function HeroVideo() {
  ...
  // React doesn't reliably reflect the `muted` PROP to the DOM, so write the
  // real `muted` content attribute on the node itself via `defaultMuted`. This
  // guarantees the demo is silent by default no matter how the element mounts.
